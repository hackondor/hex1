...
public class Board extends Observable {
	...
	private boolean isStealDone = false;			// è stato fatto lo steal della prima mossa
	 ...
	 * @return true se la cella è occupata
	 */
	 ...
	 * @param riga della cella
	 * @param colonna della cella
	 * @return	l'identificativo del player a cui appartiene la cella. Se è vuota ritorna la costante NOPLAYER
	 */
	...
	/**
	 * fornisce un oggetto Board che è esattamente la copia della board corrente
	...
	/**
	 * Stabilisce se lo steal della prima mossa è consentito nel corrente stato della board
	 * @return true se lo steal è consentito
	 */
